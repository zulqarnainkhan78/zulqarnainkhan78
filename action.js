...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/_.zain._02_/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/zulkarnayn-2833ab196/", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/zulkarnayn", "_blank");
    }
    if (x == 4) {
        window.open("https://zulkarnayn-portfolio-site.netlify.app/", "_blank");
    }
}
